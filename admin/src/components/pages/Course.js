...
<div>
   ...
   course can be done after <Select className="viper"
    ...
    <div className="form-group"><input  className="form-control form-control-lg" type="text"  name="eligibility" value={eligibility}   placeholder="Eligibility "  onChange={(e)=>setEligibility(e.target.value)}/><br/></div>
